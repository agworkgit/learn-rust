...
fn main() {
    // Arrays - Fixed size collection of elements of homogeneous type
    ...
    // &str (String Slice) - stored in stack memory, a reference to a portion of a string that's stored somewhere in your code, 'immutable'
